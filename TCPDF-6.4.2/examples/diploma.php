...
$cfg_usuario="root";
$cfg_password="";
$cfg_basephp1="diplomas";

$link = mysqli_connect($cfg_servidor,$cfg_usuario,$cfg_password,$cfg_basephp1);
mysqli_set_charset($link,"utf8");
$sql = "SELECT * FROM `asistentes` WHERE cedula='$cedula'";
//$_ausentismo_mes = mysqli_query($link,$sql);
$_diploma = mysqli_query($link,$sql);

$array2=mysqli_fetch_array($_diploma);
$_nombre = $array2["nombres"]." ".$array2["apellidos"];	
$_nombref = latina($_nombre);
// Para funciones propias
//============================================================+
...
$pdf->SetAuthor('DEVMAFIA.ORG');
$pdf->SetTitle('Diploma PHP');
$pdf->SetSubject('Diploma PHP');
...
// Print a text
$html = '<br/><br/><br/><br/><br/><br/><span style="color:black;text-align:right;font-weight:bold;font-size:30pt;">'.$_nombref.'</span>';
$pdf->writeHTML($html, true, false, true, false, '');
